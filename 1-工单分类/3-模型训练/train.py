...
path = os.getcwd()
trainfile = path + "/model1_train.tfrecords"
testfile = path + "/model1_test.tfrecords"
...
train_img, train_label = read_and_decode(trainfile, batch_size=80, capacity=1250, min_after_dequeue=250)
