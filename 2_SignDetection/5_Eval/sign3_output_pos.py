...
PATH_MODEL = os.path.join(os.path.pardir,'6_Model','sign3')
PATH_SET = os.path.join('..','0_Data','sign3','ImageSets','main')
...
PATH_TO_LABELS = os.path.join(os.path.join(PATH_MODEL, '7_label_map.pbtxt'))
PATH_TO_IMG = os.path.join('..','0_Data','sign3','JPEGImages')
PATH_PRED = os.path.join('..','0_Data','sign3','mAP','predicted')
NUM_CLASSES = 2
IMAGE_SIZE = (18, 18)
...
#                        print(name, points, label, score)
                    ...
                    new_f.write('sign3' + " " + str(1.0) + " " + str(0) + " " + str(0) + " " + str(0) + " " + str(0) + '\n')
            '''
