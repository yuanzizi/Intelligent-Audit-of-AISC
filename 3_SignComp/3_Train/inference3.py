...
class siamese:
    ...
    def network(self, x1, x2, training_flag=True):
        ...
        with tf.variable_scope("net") as scope:
            ...
            tf.add_to_collection('weights2', tf.contrib.layers.l2_regularizer(self.regularization_rate)(w1))
            tf.add_to_collection('weights2', tf.contrib.layers.l2_regularizer(self.regularization_rate)(w2))
            tf.add_to_collection('weights2', tf.contrib.layers.l2_regularizer(self.regularization_rate)(w3))
            tf.add_to_collection('weights2', tf.contrib.layers.l2_regularizer(self.regularization_rate)(w4))
            tf.add_to_collection('weights2', tf.contrib.layers.l2_regularizer(self.regularization_rate)(w5))
            tf.add_to_collection('weights2', tf.contrib.layers.l2_regularizer(self.regularization_rate)(w6))
            tf.add_to_collection('weights2', tf.contrib.layers.l2_regularizer(self.regularization_rate)(w7))
            tf.add_to_collection('weights2', tf.contrib.layers.l2_regularizer(self.regularization_rate)(w3_2))
    ...
    def loss_with_spring(self):
        ...
        loss = tf.reduce_mean(losses, name="loss")+tf.add_n(tf.get_collection('weights'))+tf.add_n(tf.get_collection('weights2'))
        return loss